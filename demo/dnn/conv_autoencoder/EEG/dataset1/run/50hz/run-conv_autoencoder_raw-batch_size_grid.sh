...
bpl=20
epta=10
out_dir='/scratch/akitaitsev/intersubject_generalization/dnn/conv_autoencoder/conv_autoencoder_raw/EEG/dataset1/50hz/batch_size-grid/'
...
python conv_autoencoder_raw.py -gpu -out_dir $out_dirs -lr $lr -batch_size $batch_sizes -scale 0 -normalize 0 -n_epochs $n_epochs
