...
bpl=20
epta=10
out_dir='/scratch/akitaitsev/intersubject_generalization/dnn/conv_autoencoder/conv_autoencoder_raw/EEG/dataset1/50hz/ch-grid-ver2/'
lr=0.01

enc_ch1=(32 64 128 256)
enc_ch2=(64 128 256 512)
enc_ch3=(128 256 512 1024)
dec_ch1=(64 128 256 512)
dec_ch2=(32 64 128 256)
