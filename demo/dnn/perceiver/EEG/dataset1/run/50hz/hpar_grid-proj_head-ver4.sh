...
bpl=10
epta=5
out_dir="/scratch/akitaitsev/intersubject_generalization/dnn/perceiver/EEG/dataset1/leftthomas/projection_head/50hz/hpar-grid-ver4/"
...
perc_latent_head=(1 2)
perc_depth=(1 3 6)
out_dim_ENC=(50 200) # as if mvica with PCA 200
out_dim_PH=(50 100) # as if mvica with PCA 100
