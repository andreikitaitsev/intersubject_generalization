...
class ContrastiveLossManual(torch.nn.Module):
...
if __name__=='__main__':
    ...
    parser.add_argument('-use_man_loss', action='store_true', default=False)
    ...
    if man_loss:
        loss_fn = ContrastiveLossManual(batch_size, temperature)
    else:
