...
if __name__=='__main__':
    ...
    '/scratch/akitaitsev/intersubject_generalization/dnn/perceiver/trial3/CIFAR/zablo/',
    help='default=/scratch/akitaitsev/intersubject_generalization/dnn/perceiver/trial3/CIFAR/zablo/')
    ...
    # define loss to use - zablo
    loss_fn = ContrastiveLoss_zablo(args.batch_size, args.temperature, device="cuda") 
