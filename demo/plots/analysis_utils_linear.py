...
def saturation_topplot(tops, sds, fig=None, ax=None, xtick_labels=None, xpos=None, title=None, \
...
def plot_saturation_profile(tops_av, sds_av, tops_sw, sds_sw, xtick_labels, labels=None, title=None, top=1,\
    ...
    for n, ax in enumerate(axes):
        fig, ax = saturation_topplot(tops[n], sds[n], xtick_labels = xtick_labels, \
