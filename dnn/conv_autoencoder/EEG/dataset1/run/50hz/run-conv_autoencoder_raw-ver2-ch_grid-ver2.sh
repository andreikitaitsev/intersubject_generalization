...
bpl=20
epta=10
out_dir='/scratch/akitaitsev/intersubject_generalization/dnn/conv_autoencoder/conv_autoencoder_raw-ver2/EEG/dataset1/50hz/ch-grid-ver2/'

enc_ch1=(20 16 16 32)
enc_ch2=(50 32 64 64)
enc_ch3=(100 64 256 128)
enc_ch4=(200 128 512 256)
enc_ch5=(300 128 256 256)
...
python conv_autoencoder_raw-ver2.py -gpu -out_dir $out_dirs -lr $lr -batch_size $batch_size -n_epochs $n_epochs -scale 0 -normalize 0 
