...
srate='50hz'
inp_base=Path('/scratch/akitaitsev/intersubject_generalization/dnn/perceiver/EEG/dataset1/leftthomas/',\
    'projection_head', srate, ('incr-'+str(args.nshuffles)+'shuffle-'+str(args.nsplits)+'splits'))

out_path=Path('/scratch/akitaitsev/intersubject_generalization/results/dnn/perceiver/saturation_profile/')
...
enc_av, enc_sw, dec_av, dec_sw = create_saturation_profile_data(inp_base, \
    args.nshuffles, args.steps, net='perceiver')
