...
n_epochs=1000
bpl=50
out_dir="/scratch/akitaitsev/intersubject_generalization/dnn/perceiver/EEG/leftthomas/projection_head/1000epochs/"
...
python perceiver-projection_head-eeg-leftthomas.py -gpu -batch_size $batch_size -out_dir $out_dirs -lr $lrates -bpl 50 -n_epochs $n_epochs
