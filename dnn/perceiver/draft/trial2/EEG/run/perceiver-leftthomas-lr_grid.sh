...
n_epochs=100
bpl=10
out_dir="/scratch/akitaitsev/intersubject_generalizeation/dnn/perceiver/trial2/EEG/leftthomas/"
...
python perceiver-leftthomas.py -out_dir $out_dirs -batch_size $batch_size -gpu -batch_per_loss $bpl -n_epochs $n_epochs -lr $lrates
