...
#SBATCH --job-name=lr_grid_leftthomas
...
n_epochs=100
bpl=50
out_dir="/scratch/akitaitsev/intersubject_generalization/dnn/perceiver/trial3/CIFAR/leftthomas/"
...
python perceiver-cifar-leftthomas.py -out_dir $out_dirs -batch_size $batch_size -gpu -bpl $bpl -n_epochs $n_epochs -lr $lrates
