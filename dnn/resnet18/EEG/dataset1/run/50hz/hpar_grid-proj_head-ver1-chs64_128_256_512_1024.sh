...
names=("chs64_128_256_512_1024" "proj_head_inp_dim" "proj_head_intermediate_dim" "n_features")
...
do
    ...
    do
        ...
        do
            out_dirs[$ind]=$out_dir"/"${manes[0]}"_"${names[1]]}$par1"_"${names[2]}$par2"_"${names[3]}$par3
