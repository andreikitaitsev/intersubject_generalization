...
def load_dnn_activations(base_dir, dataset):
    ...
    acts = joblib.load(base_dir.joinpath((str(dataset)+'_activations.pkl')))
    return acts
...
if __name__=='__main__':
    ...
    X_tr = load_dnn_activations(args.dnn_dir, 'train')
    X_te = load_dnn_activations(args.dnn_dir, 'test')
    ...
    if args.auto_scan:
        ...
        joblib.dump(Y_te_pred_av, out_dir.joinpath((args.region+'_test_pred_av.pkl')))
        joblib.dump(Y_te_pred_sw, out_dir.joinpath((args.region+'_test_pred_sw.pkl')))
