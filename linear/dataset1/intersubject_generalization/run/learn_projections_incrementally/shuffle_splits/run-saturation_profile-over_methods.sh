...
prepr="pca"
n_comps=200
inp_dir="/scratch/akitaitsev/intersubject_generalization/linear/dataset1/featurematrices/50hz/time_window13-40/"
out_dir_base="/scratch/akitaitsev/intersubject_generalization/linear/dataset1/intersubject_generalization/saturation_profile-different_methods/"
...
python learn_projections_incrementally_shuffle_splits.py -inp $inp_dir -out $out_dirs -method $methods -dim_reduction "pca" -n_comp 200 -nsplits $nsplits -step $steps -seed $seeds
