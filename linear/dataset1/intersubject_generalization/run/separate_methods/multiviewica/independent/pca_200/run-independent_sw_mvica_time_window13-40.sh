...
out_dir="/scratch/akitaitsev/intersubject_generalizeation/linear/intersubject_generalization/multiviewica/independent/time_window13-40/pca_200/"
method="multiviewica"
dim_reduction="pca"
n_components="200"
