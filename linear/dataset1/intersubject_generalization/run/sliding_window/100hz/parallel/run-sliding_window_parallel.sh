...
inp_dir="/scratch/akitaitsev/intersubject_generalizeation/linear/dataset_matrices/100hz/time_window26-80/"
...
do
    ...
    do
        n_comps[$ind]=$n_comp
        out_dirs[$ind]=$out_base$prepr"/"$n_comp"/100hz/parallel/time_window26-80/"
...
python sliding_window_parallel.py -inp $inp_dir -out $out_dirs -method $method -dim_reduction $preprocessors -n_comp $n_comp -wind_len $wind_len
