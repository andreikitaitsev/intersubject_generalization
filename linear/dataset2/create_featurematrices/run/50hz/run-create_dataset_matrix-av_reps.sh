...
python create_dataset_matrix.py -inp $inp_dir -out $out_dir0_40 -time 0 40 -srate $srate 

echo Creating dataset matrix for time window 13-40
python create_dataset_matrix.py -inp $inp_dir -out $out_dir13_40 -time 13 40 -srate $srate 
