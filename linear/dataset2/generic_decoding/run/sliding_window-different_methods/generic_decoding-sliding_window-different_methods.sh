...
# 8 jobs
out_base="/scratch/akitaitsev/intersubject_generalization/linear/dataset2/generic_decoding/sliding_window-different_methods/"
real_base="/scratch/akitaitsev/intersubject_generalization/linear/dataset2/intersubject_generalization/sliding_window-different_methods/"
pred_base="/scratch/akitaitsev/intersubject_generalization/linear/dataset2/regression/sliding_window-different_methods/"
...
do
    ...
    do
        ...
        real_files[$ind]=$real_base$method"/100hz/shared_test.pkl"
        pred_files[$ind]=$pred_base$method"/100hz/Y_test_predicted_"$dtype".pkl"
        dtypes[$ind]=$dtype
        ((ind=ind+1))
    done
done
