...
# 50 hz 
fls50 = (Path('raw/50hz/time_window'+str(tw50)).joinpath('av_reps'), \
    Path('control/pca_200/50hz/time_window'+str(tw50)).joinpath('av_reps'),\
    Path('multiviewica/pca_200/50hz/time_window'+str(tw50)).joinpath('av_reps'), \
    Path('permica/pca_200/50hz/time_window'+str(tw50)).joinpath('av_reps'))
...
# 100 hz 
fls100 = (Path('raw/100hz/time_window'+str(tw100)).joinpath('av_reps'), \
    Path('control/pca_200/100hz/time_window'+str(tw100)).joinpath('av_reps'),\
    Path('multiviewica/pca_200/100hz/time_window'+str(tw100)).joinpath('av_reps'), \
    Path('permica/pca_200/100hz/time_window'+str(tw100)).joinpath('av_reps'))
...
# 200 hz 
fls200 = (Path('raw/200hz/time_window'+str(tw200)).joinpath('av_reps'), \
    Path('control/pca_200/200hz/time_window'+str(tw200)).joinpath('av_reps'),\
    Path('multiviewica/pca_200/200hz/time_window'+str(tw200)).joinpath('av_reps'), \
    Path('permica/pca_200/200hz/time_window'+str(tw200)).joinpath('av_reps'))
