...
parser.add_argument('-fig_name', type=str, 
    default='sliding_window_different_methods-dataset2.png', help='Figure name. Default=sliding_window_different_methods-dataset2.png')
parser.add_argument('-data_name', type=str, default='sliding_window_different_methods-dataset2.csv', help='Data name.\
    Default=sliding_window_different_methods-dataset2.csv')
...
if args.save_fig:
    fig1.savefig(out_path1.joinpath(args.fig_name), dpi=300)
if args.save_data:    
