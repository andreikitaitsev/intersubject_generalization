...
srate=200
# create inputs
eeg_dir="/scratch/akitaitsev/intersubject_generalization/linear/dataset2/intersubject_generalization/multiviewica/pca_200/"$srate"hz/time_window"
dnn_dir="/scratch/akitaitsev/encoding_Ale/dnn_activations/dataset2/"
out_dir="/scratch/akitaitsev/intersubject_generalizeation/linear/dataset2/regression/multiviewica/pca_200/"$srate"hz/time_window"
