...
# create inputs
eeg_dir="/scratch/akitaitsev/intersubject_generalizeation/linear/intersubject_generalization/control/pca/200/time_window"
dnn_dir="/scratch/akitaitsev/encoding_Ale/dnn_activations/"
out_dir="/scratch/akitaitsev/intersubject_generalizeation/linear/regression/control/pca/200/time_window"
