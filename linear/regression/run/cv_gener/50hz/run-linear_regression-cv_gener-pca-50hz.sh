...
eeg_dir_base="/scratch/akitaitsev/intersubject_generalizeation/linear/intersubject_generalization/cross_val/"
out_dir_base="/scratch/akitaitsev/intersubject_generalizeation/linear/regression/"
prepr="pca"
