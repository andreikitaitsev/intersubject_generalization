...
eeg_dir_base="/scratch/akitaitsev/intersubject_generalizeation/linear/intersubject_generalization/incremental/"
out_dir_base="/scratch/akitaitsev/intersubject_generalizeation/linear/regression/incremental/"
method="multiviewica"
prepr="pca"
...
python linear_regression.py -eeg_dir $eeg_dirs -dnn_dir $dnn_dir -out_dir $out_dirs -regr_type $regr_types -incr_train_data
