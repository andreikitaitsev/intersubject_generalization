...
eeg_dir_base="/scratch/akitaitsev/intersubject_generalizeation/linear/intersubject_generalization/learn_projections_incrementally/"
out_dir_base="/scratch/akitaitsev/intersubject_generalizeation/linear/regression/learn_projections_incrementally/"
method="multiviewica"
prepr="pca"
...
do
    ...
    do
        ...
        do
            eeg_dirs[$ind]=$eeg_dir_base"/"$method"/"$prepr"/"$n_comp"/50hz/time_window13-40/1-10percent/step_"$(printf '%d' $step)"/"
            out_dirs[$ind]=$out_dir_base"/"$method"/"$prepr"/"$n_comp"/50hz/time_window13-40/1-10percent/step_"$(printf '%d' $step)"/"
