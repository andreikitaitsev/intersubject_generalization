...
eeg_dir_base="/scratch/akitaitsev/intersubject_generalizeation/linear/intersubject_generalization/learn_projections_incrementally/shuffle_splits/"$nsplits"splits/"$method"/"$prepr"/"
out_dir_base="/scratch/akitaitsev/intersubject_generalizeation/linear/regression/learn_projections_incrementally/shuffle_splits/"$nsplits"splits/"$method"/"$prepr
