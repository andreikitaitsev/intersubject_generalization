...
# create inputs
eeg_dir="/scratch/akitaitsev/intersubject_generalizeation/linear/intersubject_generalization/multiviewica/independent/time_window0-40/pca_200/"
dnn_dir="/scratch/akitaitsev/encoding_Ale/dnn_activations/"
out_dir="/scratch/akitaitsev/intersubject_generalizeation/linear/regression/on_generalized_data/multiviewica/independent/time_window0-40/pca_200/"
