...
# create inputs
# tmp dirs
eeg_dir="/scratch/akitaitsev/intersubject_generalizeation/linear/intersubject_generalization/multiviewica/main/srm/200/time_window"
dnn_dir="/scratch/akitaitsev/encoding_Ale/dnn_activations/"
out_dir="/scratch/akitaitsev/intersubject_generalizeation/linear/regression/multiviewica/main/srm/200/time_window"
