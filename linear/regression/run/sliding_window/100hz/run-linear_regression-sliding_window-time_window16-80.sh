...
eeg_dir_base="/scratch/akitaitsev/intersubject_generalizeation/linear/intersubject_generalization/sliding_window/multiviewica/main/"
out_dir_base="/scratch/akitaitsev/intersubject_generalizeation/linear/regression/sliding_window/multiviewica/main/"
...
do
    ...
    do
        ...
        do
            ...
            n_comps[$ind]=$n_comp
            eeg_dirs[$ind]=$eeg_dir_base"/"$prepr"/"$n_comp"/100hz/time_window16-80/"
            out_dirs[$ind]=$out_dir_base"/"$prepr"/"$n_comp"/100hz/time_window16-80/"
            ((ind=ind+1))
        done
    done
done
