...
bpl=10
epta=5
out_dir="/scratch/akitaitsev/intersubject_generalization/dnn/perceiver/EEG/dataset1/leftthomas/projection_head/"$srate"hz/hpar-grid-ver8/"
...
cross_head=(1)
cross_dim_head=(128 256)
latent_dim_head=(64 256)
self_per_cross_attn=(2 8)
num_freq_band=(6 12)
