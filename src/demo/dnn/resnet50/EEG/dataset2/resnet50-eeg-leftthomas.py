...
if __name__=='__main__':
    ...
    '/scratch/akitaitsev/intersubject_generalization/dnn/resnet/EEG/leftthomas/draft/',
    help='/scratch/akitaitsev/intersubject_generalization/dnn/resnet/EEG/leftthomas/draft/')
    ...
    'layer. Default=2048')
    parser.add_argument('-proj_head_intermediate_dim', type=int, default=2048, help='Intermediate dim of '
    ...
    '/dataset2/dataset_matrices/50hz/time_window13-40/av_reps/', help='EEG dataset dir. Default= '
    '/scratch/akitaitsev/intersubject_generalization/linear/dataset2/dataset_matrices/50hz/time_window13-40/av_reps/')
    ...
    # define the model
    model = resnet50_leftthomas(args.n_ch, args.out_ch, args.kernel_size, args.proj_head_inp_dim,\
