...
class dataset(torch.utils.data.Dataset):
    ...
    '''
    def __init__(self, data, normalize=True, tanh=False, scale=True, subj_idx=0):
        '''
        Inputs:
    ...
    def __getitem__(self, idx):
        return self.data[idx, self.subj_idx,:,:].unsqueeze(0)
...
if __name__=='__main__':
    ...
    dataset_train = dataset(data_train, normalize=True, tanh=False, scale=True)
    dataset_test = dataset(data_test, normalize=True, tanh=False, scale=True)
    ...
    # define the model
    model = conv_autoencoder_raw(n_subj = 1, enc_ch1 = args.enc_chs[0], enc_ch2 = args.enc_chs[1],\
