...
eeg_dir_base="/scratch/akitaitsev/intersubject_generalization/linear/dataset2/intersubject_generalization/"\
"saturation_profile-different_methods/"
out_dir_base="/scratch/akitaitsev/intersubject_generalization/linear/dataset2/regression/saturation_profile-different_methods/"
...
python linear_regression.py -eeg_dir $eeg_dirs -dnn_dir $dnn_dir -out_dir $out_dirs -regr_type $regr_type -skip_val 
