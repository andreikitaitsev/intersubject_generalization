...
out_dir_base='/scratch/akitaitsev/fMRI_Algonautus/activations/cornet_s/'
...
do
    n_comps[$ind]=$n_comp
    out_dirs[$ind]=$out_dir_base$dim_red$n_comp'/'
    ((ind=ind+1))
done
...
python extract_features-cornet_s.py -video_dir $video_dir -out_dir $out_dirs -n_comp $n_comps -postprocessor $dim_red
