...
if __name__ =='__main__':
    ...
    parser.add_argument('-layer', type=str, help='Layers of DNN.')
    ...
    if args.auto_scan:
        ...
        for ncomp in comps[args.region]:
            ...
            real_data = joblib.load(basedir_real_it.joinpath((layer+'_'+args.region+'_shared_test.pkl')))
            pred_data = joblib.load(basedir_pred_it.joinpath(layer+'_'+av_sw_pred_fnames(args.region, \
            ...
            joblib.dump(cor, outdir_it.joinpath((layer+'_'+args.region+'generic_decoding_correlations_'\
                +args.regr_type+'pkl'))) 
            joblib.dump(res, outdir_it.joinpath((layer+'_'+args.region+'generic_decoding_results_'\
                +args.regr_type+'.pkl')))
