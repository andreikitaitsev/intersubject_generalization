...
if __name__ =='__main__':
    ...
    parser.add_argument('-regr_type', type=str, help="Type of shared space input data"
    ...
    if args.auto_scan:
        ...
        for ncomp in comps[args.region]:
            ...
            joblib.dump(cor, outdir_it.joinpath((args.region+'_generic_decoding_correlations_'\
                +args.regr_type+'pkl'))) 
            joblib.dump(res, outdir_it.joinpath((args.region+'_generic_decoding_results_'\
                +args.regr_type+'.pkl')))
