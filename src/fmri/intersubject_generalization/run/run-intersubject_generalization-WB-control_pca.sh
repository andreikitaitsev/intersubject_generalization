...
method='PCA'
out_dir_base='/scratch/akitaitsev/fMRI_Algonautus/intersubject_generalization/'$method'/'$track'/'
comp_list=(10 50 100)
region='WB'
...
python dim_reduction.py -inp $inp_dir -out $out_dirs -dim_reduction $method -n_comp $n_comps -region $region
