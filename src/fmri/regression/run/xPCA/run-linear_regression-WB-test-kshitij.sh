...
# N JOBS=6
layers=('layer1' 'layer2' 'layer3' 'fc' 'avgpool')
track='full_track'
method='PCA'
x_dim_red='PCA'
x_n_comp_list=(100 1000)
y_dim_red='PCA'
x_dir_base='/scratch/akitaitsev/fMRI_Algonautus/dnn_features/resnet18/kshitij/pca'
y_dir_base='/scratch/akitaitsev/fMRI_Algonautus/intersubject_generalization/'$method'/full_track/'
out_dir_base='/scratch/akitaitsev/fMRI_Algonautus/regression/kshitij/'$method'/'$track'/'
comp_list=(10 50 100)
region='WB'
...
do
    ...
    do
        x_dirs[$ind]=$x_dir_base$x_n_comp"/"
...
python linear_regression-layerwise.py -x_dir $x_dirs -y_dir $y_dirs -out $out_dirs -region $region -layers ${layers[*]}
