...
out_dir="/scratch/akitaitsev/intersubject_generalization/dnn/perceiver/EEG/dataset1/leftthomas/projection_head/"$srate"hz/hpar-grid-ver10/"
names=("share_weights" "no_share_weights")


lat_ar_dim=(200 200)
num_latent_dim=(50 50)
latent_head=(1 1)
depth=(1 1)
out_dim_ENC=(200 200)
out_dim_PH=(100 100)
cross_head=(1 1)
cross_dim_head=(64 64)
latent_dim_head=(64 64)
self_per_cross_attn=(2 2)
num_freq_band=(12 12)
share_weights=(1 0)
