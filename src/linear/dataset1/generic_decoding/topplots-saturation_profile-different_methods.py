...
parser.add_argument('-inp_dir', type=str, default='/scratch/akitaitsev/intersubject_generalization/linear/dataset1/generic_decoding/saturation_profile-different_methods/', help='Default=/scratch/akitaitsev/intersubject_generalization/linear/dataset1/generic_decoding/'\
...
out_path=Path('/scratch/akitaitsev/intersubject_generalization/results/linear/saturation_profile-different_methods/dataset1/')
